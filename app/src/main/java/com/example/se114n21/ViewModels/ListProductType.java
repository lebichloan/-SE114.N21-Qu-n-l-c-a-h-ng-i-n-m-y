                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    myRef.removeValue(new DatabaseReference.CompletionListener() {
                        ...
                        public void onComplete(@Nullable DatabaseError error, @NonNull DatabaseReference ref) {
                            ...
                            Toast.makeText(ListProductType.this, "Xóa loại sản phẩm thành công!", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            })
...
//                UPDATE
                ...
                myRef.updateChildren(map, new DatabaseReference.CompletionListener() {
                    ...
                    public void onComplete(@Nullable DatabaseError error, @NonNull DatabaseReference ref) {
                        progressDialog.dismiss();
                        Toast.makeText(ListProductType.this, "Cập nhật thông tin loại sản phẩm thành công", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void getListProductType() {
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(ListProductType.this, "Có lỗi xảy ra khi hiển thị danh sách sản phẩm", Toast.LENGTH_SHORT).show();
            }
        });
    }
