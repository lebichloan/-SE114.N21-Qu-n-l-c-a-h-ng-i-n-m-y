...
public class ItemBaoCao {
    ...
    public ItemBaoCao(String ngay, Integer tongNgay, Integer soLuongNgay, List<HoaDon> danhSachHoaDon) {
        Ngay = ngay;
        TongNgay = tongNgay;
    ...
    public void setDanhSachHoaDon(List<HoaDon> danhSachHoaDon) {
        DanhSachHoaDon.addAll(danhSachHoaDon);
    }

    public void addHoaDon(HoaDon hoaDon) {
        this.DanhSachHoaDon.add(hoaDon);
        this.SoLuongNgay = this.SoLuongNgay + 1;
        this.TongNgay = this.TongNgay + hoaDon.getTongTienPhaiTra();
    }
}
