...
public final class ActivityForgotPasswordBinding implements ViewBinding {
  ...
  @NonNull
  public final EditText txtForgotPasswordEmail;

  private ActivityForgotPasswordBinding(@NonNull LinearLayout rootView,
      @NonNull ImageButton butBack, @NonNull Button butNext,
      @NonNull EditText txtForgotPasswordEmail) {
    this.rootView = rootView;
    this.butBack = butBack;
    this.butNext = butNext;
    this.txtForgotPasswordEmail = txtForgotPasswordEmail;
  }
  ...
  public static ActivityForgotPasswordBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.txtForgotPasswordEmail;
      EditText txtForgotPasswordEmail = ViewBindings.findChildViewById(rootView, id);
      if (txtForgotPasswordEmail == null) {
        break missingId;
      }

      return new ActivityForgotPasswordBinding((LinearLayout) rootView, butBack, butNext,
